...
import { createBrandLockup, workbenchChoices, workbenchPaths, } from "./workbench-chrome.js";
 ...
 */
export function mountChooserApp(root) {
    ...
    const context = el("section", { class: "att-context" }, [
        el("div", { class: "att-frame att-context-inner" }, [
            el("div", { class: "att-context-title" }, [
                el("p", { class: "att-kicker" }, ["Senda DevTools"]),
    ...
    const main = el("main", { class: "att-frame att-main" }, [
        el("div", { class: "att-choices" }, workbenchChoices.map((choice) => createChoice(choice))),
        el("aside", { class: "att-card att-choice-note" }, [
            ...
            el("p", { class: "att-mono" }, ["senda-devtools serve dist/engine.js"]),
            el("p", { class: "att-hint" }, [
    ...
    root.querySelector(".att-choice")?.focus();
    return {
        destroy() {
...
//# sourceMappingURL=chooser-app.js.map