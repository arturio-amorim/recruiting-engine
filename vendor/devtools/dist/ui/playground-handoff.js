...
export function prefillKeyFor(capabilityId) {
    return `senda-devtools:prefill:${capabilityId}`;
}
/**
 ...
 */
export function openCapabilityInPlayground(capabilityId, prefill) {
    ...
    try {
        if (typeof CustomEvent === "function" &&
            ...
            document.dispatchEvent(new CustomEvent("senda:select-capability", {
...
//# sourceMappingURL=playground-handoff.js.map