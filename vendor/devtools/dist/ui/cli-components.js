...
export function cliControlId(name) {
    controlSequence += 1;
    return `cli-${name}-${String(controlSequence)}`;
}
export function cliLabelFor(text, id, className = "att-label") {
...
export function cliAnnotationTags(annotations) {
...
export function cliActivityTable(records) {
...
export function cliStatusPill(state) {
...
//# sourceMappingURL=cli-components.js.map