...
export declare const ATTACHED_CLI_SESSION_LIMITS: Readonly<{
    listTimeoutMs: 15000;
    describeTimeoutMs: 15000;
    runTimeoutMs: 60000;
    streamBytes: number;
    catalogSummaries: 2000;
    inputArgumentBytes: 98304;
    activityRecords: 500;
    retainedActivityRecords: 50;
    displayedNameCodePoints: 256;
}>;
export type AttachedCliSessionErrorCode = "INVALID_TARGET" | "SPAWN_FAILED" | "CONNECTION_FAILED" | "PROTOCOL_ERROR" | "TIMEOUT" | "LIMIT_EXCEEDED" | "TARGET_BUSY" | "NOT_CONNECTED" | "ENVIRONMENT_VALUE_MISSING";
export declare class AttachedCliSessionError extends Error {
    readonly code: AttachedCliSessionErrorCode;
    readonly message: string;
    constructor(code: AttachedCliSessionErrorCode, options?: ErrorOptions);
}
export declare function attachedCliError(code: AttachedCliSessionErrorCode, cause?: unknown): AttachedCliSessionError;
...
export interface AttachedCliCapabilityDescription extends AttachedCliCapabilitySummary {
...
export type AttachedCliSpawn = (command: string, args: readonly string[], options: AttachedCliSpawnOptions) => ChildProcess;
...
export interface AttachedCliSessionController {
    connect(owner: string, target: unknown): Promise<AttachedCliConnectionSummary>;
    refresh(owner: string): Promise<AttachedCliConnectionSummary>;
    describe(owner: string, id: string): Promise<AttachedCliCapabilityDescription>;
...
//# sourceMappingURL=cli-attached-contract.d.ts.map