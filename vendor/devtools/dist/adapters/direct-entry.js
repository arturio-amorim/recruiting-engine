...
import { childUsageExitCode, loadChildEngine, readChildEngineArguments, readChildPrincipal, } from "./child-context.js";
/**
...
if (args === undefined ||
    ...
    process.stderr.write("The direct adapter child requires a module, export, capability, and input.\n");
...
try {
    ...
    process.stderr.write(serialize({
...
try {
    ...
    process.stderr.write(error instanceof EngineError
...
//# sourceMappingURL=direct-entry.js.map