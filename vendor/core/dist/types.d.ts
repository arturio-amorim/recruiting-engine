...
import type { EngineJsonSchema, EngineSchema, InferSchemaInput, InferSchemaOutput } from "./schema.js";
...
export type AccessRule<Input> = "public" | "authenticated" | ((args: {
    readonly principal: Principal | null;
...
export interface CapabilityDefinition<InputSchema extends EngineSchema, OutputSchema extends EngineSchema> {
