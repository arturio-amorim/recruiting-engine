...
import { createMcpHttpScaffoldFiles, starterDeployManifest, } from "./scaffold/index.js";
 ...
 */
export async function runInit(args, context) {
    if (args.length > 0) {
