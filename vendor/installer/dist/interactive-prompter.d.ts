...
export interface AutocompletePrompt<Value extends string> extends ChoicePrompt<Value> {
    readonly placeholder?: string;
    readonly initialValue?: Value;
}
export interface SelectPrompt<Value extends string> extends ChoicePrompt<Value> {
    readonly initialValue?: Value;
}
export interface MultiselectPrompt<Value extends string> extends ChoicePrompt<Value> {
...
export type InteractiveLogLevel = "info" | "success" | "step" | "warn" | "error";
/**
...
export interface InteractivePrompter {
    ...
    readonly cancel: (message: string) => void;
    readonly autocomplete: <Value extends string>(prompt: AutocompletePrompt<Value>) => Promise<PromptOutcome<Value>>;
    readonly select: <Value extends string>(prompt: SelectPrompt<Value>) => Promise<PromptOutcome<Value>>;
    readonly multiselect: <Value extends string>(prompt: MultiselectPrompt<Value>) => Promise<PromptOutcome<readonly Value[]>>;
...
export {};
//# sourceMappingURL=interactive-prompter.d.ts.map