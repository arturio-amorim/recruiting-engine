...
export const configurationTargetCatalog = Object.freeze([
    target({
        ...
        reloadHint: "In AGY use /mcp to reload; in the IDE refresh MCP servers or restart it.",
    }),
    target({
        id: "claude-code",
        displayName: "Claude Code",
    ...
    target({
        id: "openclaw",
        displayName: "OpenClaw",
        reloadHint: "Let an active config watcher hot-apply the change; otherwise restart the Gateway, then inspect with openclaw mcp status.",
    }),
    target({
        id: "opencode-v2",
        displayName: "OpenCode v2",
