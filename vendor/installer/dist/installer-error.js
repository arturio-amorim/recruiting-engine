export const installerErrorMessages = Object.freeze({
    ...
    HARNESS_CONFIG_AMBIGUOUS: "More than one harness configuration could be selected.",
    ...
    TARGET_UNSUPPORTED: "This capability cannot be configured for the selected harness.",
...
export function renderInstallerDiagnostic(error) {
    return `${error.code}: ${installerErrorMessages[error.code]}\n`;
}
//# sourceMappingURL=installer-error.js.map